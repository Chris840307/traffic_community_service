...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <form class="simple_form form-inline" action="query.php" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="authenticity_token" value="i0l4hOWinm/w4zbWAFAnsh7dC3xft6WCdeCoSUiDRF+hmddzcog4b/B48OAL25c5FBTq6WsE6x+hb5v4xD07UQ==">
      ...
      <label for="search_sn" class="col-sm-2 col-form-label">密碼:</label>
        <input class="form-control string required form-control form-control-sm" value="" autocomplete="off" required="required" aria-required="true" type="text" name="search[pwd]" id="search_pwd">
