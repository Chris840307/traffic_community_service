    ...
    <div class="card mb-3">
      <div class="card-header">
        ...
        <div class="float-right">
            <a class="btn btn-primary btn-sm" href="admin2_users.php">回到列表</a>
    <a class="btn btn-info btn-sm" href="admin2_users_edit.php?id=<?=$row["id"];?>">編輯</a>
    <a data-confirm="確定刪除?" class="btn btn-danger btn-sm" rel="nofollow" data-method="delete" href="admin2_users.php?id=<?=$row["id"];?>">刪除</a>
