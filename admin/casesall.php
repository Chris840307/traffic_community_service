...
$pdo->prepare("UPDATE `cases` SET `DetectLocation`=CONCAT(COALESCE(`groupp1`,''),'-',COALESCE(`groupp2`,''),'-',COALESCE(`groupp3`,''))");
...
<form class="search-form" id="case_search" autocomplete="off" action="casesall.php?commit=搜尋" accept-charset="UTF-8" method="post">
<?php } else { ?>
<form class="search-form" id="case_search" autocomplete="off" action="casesall.php?state=<?=$_GET["state"];?>" accept-charset="UTF-8" method="post">
<?php } ?>

<table>
<tr>
<td>查詢事由:&nbsp;&nbsp;</td>
<td><select size="1" class="select2" name="searchr" id="searchr">
<?php
$resultsr = $pdo->query("SELECT * FROM `search_reason`");
while($rowsr = $resultsr->fetch(PDO::FETCH_ASSOC)){
echo '<option>'.$rowsr["name"].'</option>';
}
?>
</select>
	...
	<input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="j3/lL1eQpbJQX2nsNmnYnB0YepKTccVgjYBPfbJ6zdZF7S3stVLHykb5++JvY6jaYeGtFHmJr1TA+b305mNN9w==" />
	  ...
	  <!--<a class="add_search_fields btn btn-sm btn-success" data-id="new_condition" data-fields="&lt;div class=&quot;input-group mb-3 field&quot;&gt;  &lt;div class=&quot;input-group-prepend&quot;&gt;          &lt;select class=&quot;custom-select attribute-select&quot; name=&quot;q[c][new_condition][a][0][name]&quot; id=&quot;q_c_new_condition_a_0_name&quot;&gt;&lt;option value=&quot;&quot;&gt;請選擇欄位&lt;/option&gt;&lt;optgroup label=&quot;科技執法案件&quot;&gt;&lt;option value=&quot;full_car_number&quot;&gt;違規車號&lt;/option&gt;&lt;option value=&quot;sn&quot;&gt;案件編號&lt;/option&gt;&lt;option value=&quot;contact_address&quot;&gt;聯絡地址&lt;/option&gt;&lt;option value=&quot;expose&quot;&gt;是否舉發&lt;/option&gt;&lt;option value=&quot;illegality_details&quot;&gt;違規事實說明&lt;/option&gt;&lt;option value=&quot;created_at&quot;&gt;違規日期／時間&lt;/option&gt;&lt;option value=&quot;phone&quot;&gt;聯絡電話&lt;/option&gt;&lt;option value=&quot;addr1&quot;&gt;巷&lt;/option&gt;&lt;option value=&quot;addr2&quot;&gt;弄&lt;/option&gt;&lt;option value=&quot;addr3&quot;&gt;號&lt;/option&gt;&lt;option value=&quot;addr4&quot;&gt;之號&lt;/option&gt;&lt;option value=&quot;addr5&quot;&gt;公里處&lt;/option&gt;&lt;option value=&quot;area_district&quot;&gt;違規區域&lt;/option&gt;&lt;option value=&quot;addr_detail&quot;&gt;詳細地址&lt;/option&gt;&lt;option value=&quot;email&quot;&gt;Email&lt;/option&gt;&lt;option value=&quot;username&quot;&gt;申請人姓名&lt;/option&gt;&lt;option value=&quot;id_number&quot;&gt;身分證字號&lt;/option&gt;&lt;option value=&quot;state&quot;&gt;狀態&lt;/option&gt;&lt;option value=&quot;created_at&quot;&gt;檢舉日期／時間&lt;/option&gt;&lt;/optgroup&gt;&lt;optgroup label=&quot;違規事實&quot;&gt;&lt;option value=&quot;illegality_code&quot;&gt;違規項目代碼&lt;/option&gt;&lt;option value=&quot;illegality_name&quot;&gt;違規事實名稱&lt;/option&gt;&lt;/optgroup&gt;&lt;optgroup label=&quot;違規街道&quot;&gt;&lt;option value=&quot;area_code&quot;&gt;違規街道代碼&lt;/option&gt;&lt;option value=&quot;area_name&quot;&gt;街道名稱&lt;/option&gt;&lt;/optgroup&gt;&lt;optgroup label=&quot;違規法條&quot;&gt;&lt;option value=&quot;expose_reason_code&quot;&gt;違規法條代碼&lt;/option&gt;&lt;option value=&quot;expose_reason_name&quot;&gt;違規法條名稱&lt;/option&gt;&lt;/optgroup&gt;&lt;optgroup label=&quot;單位&quot;&gt;&lt;option value=&quot;department_name&quot;&gt;單位名稱&lt;/option&gt;&lt;/optgroup&gt;&lt;optgroup label=&quot;員警&quot;&gt;&lt;option value=&quot;approved_admin_user_name&quot;&gt;姓名&lt;/option&gt;&lt;/optgroup&gt;&lt;/select&gt;  &lt;/div&gt;  &lt;div class=&quot;input-group-prepend&quot;&gt;    &lt;select class=&quot;custom-select search-condition&quot; name=&quot;q[c][new_condition][p]&quot; id=&quot;q_c_new_condition_p&quot;&gt;&lt;option value=&quot;eq&quot;&gt;等於&lt;/option&gt;&lt;option value=&quot;not_eq&quot;&gt;不等於&lt;/option&gt;&lt;option value=&quot;lteq&quot;&gt;小於或等於&lt;/option&gt;&lt;option value=&quot;gteq&quot;&gt;大於或等於&lt;/option&gt;&lt;option selected=&quot;selected&quot; value=&quot;cont&quot;&gt;包含&lt;/option&gt;&lt;/select&gt;  &lt;/div&gt;  &lt;div class=&quot;search-input-wrapper&quot;&gt;          &lt;input class=&quot;form-control search-value-input input-sm&quot; type=&quot;text&quot; name=&quot;q[c][new_condition][v][0][value]&quot; id=&quot;q_c_new_condition_v_0_value&quot; /&gt;  &lt;/div&gt;  &lt;div class=&quot;input-group-append&quot;&gt;    &lt;a class=&quot;remove_search_fields btn btn-sm btn-danger&quot; href=&quot;#&quot;&gt;&lt;i class=&quot;fas fa-minus-circle&quot;&gt;&lt;/i&gt;&lt;/a&gt;  &lt;/div&gt;&lt;/div&gt;" href="#">-->
<a class="add_search_fields btn btn-sm btn-success" data-id="new_condition" data-fields="&lt;div class=&quot;input-group mb-3 field&quot;&gt;  &lt;div class=&quot;input-group-prepend&quot;&gt;          &lt;select class=&quot;custom-select attribute-select&quot; name=&quot;q[c][new_condition][a][0][name]&quot; id=&quot;q_c_new_condition_a_0_name&quot;&gt;&lt;option value=&quot;&quot;&gt;請選擇欄位&lt;/option&gt;&lt;optgroup label=&quot;申請案件&quot;&gt;&lt;option value=&quot;sn&quot;&gt;案件編號&lt;/option&gt;&lt;option value=&quot;username&quot;&gt;申請人姓名&lt;/option&gt;&lt;option value=&quot;username2&quot;&gt;當事人姓名&lt;/option&gt;&lt;option value=&quot;email&quot;&gt;申請人信箱&lt;/option&gt;&lt;option value=&quot;category_name&quot;&gt;案件類別&lt;/option&gt;&lt;option value=&quot;DetectLocation&quot;&gt;申請項目&lt;/option&gt;&lt;option value=&quot;review_username&quot;&gt;處理員警&lt;/option&gt;&lt;option value=&quot;violated_end&quot;&gt;違規逾期天數&lt;/option&gt;&lt;option value=&quot;created_at&quot;&gt;送件日期／時間&lt;/option&gt;&lt;option value=&quot;violated_at&quot;&gt;發生日期／時間&lt;/option&gt;&lt;option value=&quot;complete_date&quot;&gt;結案日期／時間&lt;/option&gt;&lt;option value=&quot;expose&quot;&gt;結案方式&lt;/option&gt;&lt;option value=&quot;state&quot;&gt;狀態&lt;/option&gt;&lt;/select&gt;  &lt;/div&gt;  &lt;div class=&quot;input-group-prepend&quot;&gt;    &lt;select class=&quot;custom-select search-condition&quot; name=&quot;q[c][new_condition][p]&quot; id=&quot;q_c_new_condition_p&quot;&gt;&lt;option value=&quot;eq&quot;&gt;等於&lt;/option&gt;&lt;option value=&quot;not_eq&quot;&gt;不等於&lt;/option&gt;&lt;option value=&quot;lteq&quot;&gt;小於或等於&lt;/option&gt;&lt;option value=&quot;gteq&quot;&gt;大於或等於&lt;/option&gt;&lt;option selected=&quot;selected&quot; value=&quot;cont&quot;&gt;包含&lt;/option&gt;&lt;/select&gt;  &lt;/div&gt;  &lt;div class=&quot;search-input-wrapper&quot;&gt;          &lt;input class=&quot;form-control search-value-input input-sm&quot; type=&quot;text&quot; name=&quot;q[c][new_condition][v][0][value]&quot; id=&quot;q_c_new_condition_v_0_value&quot; /&gt;  &lt;/div&gt;  &lt;div class=&quot;input-group-append&quot;&gt;    &lt;a class=&quot;remove_search_fields btn btn-sm btn-danger&quot; href=&quot;#&quot;&gt;&lt;i class=&quot;fas fa-minus-circle&quot;&gt;&lt;/i&gt;&lt;/a&gt;  &lt;/div&gt;&lt;/div&gt;" href="#"><i class="fas fa-plus-circle"></i></a>
...
foreach( $_SESSION['formdata'] as $key => $value ) {
        ...
        $sqlx .= "".$value["a"][0]["name"]." like '%".$value["v"][0]["value"]."%'";
                ...
                if( $value["a"][0]["name"] == "violated_end" ) {
                        $sqlx .= "violated_at between current_timestamp() - interval 60 day  and current_timestamp() - interval '".$value["v"][0]["value"]."' day";
                } else {
...
if( $_POST["commit"] == "" ) {
	...
	if( $row_user["department"] != "最高權限" ) {
        ...
        if( $orcheck == 0 ) {
		$sqlx .= "`auto_department`='".$row_user["department"]."'";
                $orcheck++;
        } else {
                $sqlx .= " or `auto_department`='".$row_user["department"]."'";
        }
	}
	 */
...
$result = $pdo->query("select id from `cases` $sqlx");
$allRecrods = $result->rowCount();
$totoalPages = ceil($allRecrods / $limit);

$prev = $page - 1;
$next = $page + 1;
if( $_POST["commit"] == "搜尋" || $_GET["commit"] == "搜尋" ) {
$cdate = date("Y-m-d H:i:s");
$pdo->prepare("INSERT INTO `search_log` (`id`,`username`, `ip`,`searchr`,`useragent`,`detail`,`cdate`) VALUES (NULL,?,?,?,?,?,? )")->execute(array($row_user["name"],$_SERVER["REMOTE_ADDR"],$_POST["searchr"],$_SERVER["HTTP_USER_AGENT"],json_encode($_REQUEST),$cdate));
    ...
    <div class="table-responsive">
      <table class="table table-bordered table-sm text-wrap table-condensed">
        <thead>
          <tr>
            <th>項次</th>
<?php if( $_GET["state"] == "recheck" || $_GET["state"] == "no" || $_GET["state"] == "nready" || $_GET["state"] == "ready" || $_GET["state"] == "reviewing" || $_SESSION['formdata'][0]['v'][0]['value'] == "reviewing" ) { ?>
...
if( $_GET["min"] != "" && $_GET["max"] != "" && $_GET["full_car_number"] != "" ) {
	        $result = $pdo->query("select * from `cases` where `full_car_number`='".$_GET["full_car_number"]."' and `created_at`>='".$_GET["max"]."' and `created_at`<='".$_GET["min"]."' order by `created_at` desc LIMIT $paginationStart, $limit");
} else {
...
?>
  ...
  <td><?php 
	echo $i;
?></td>
<td class="case_sn"><a href="cases_edit_off.php?id=<?php echo $row["id"];?>&state=<?=$row["state"];?>&min=<?=$_GET["min"];?>&max=<?=$_GET["max"];?>&full_car_number=<?=$_GET["full_car_number"];?>&commit=<?=$_GET["commit"];?>"><?php echo $row["sn"];?></a>
<br>
<?php
...
?>
            ...
            <td id="created_at_<?php echo $row["id"];?>" class="case_created_at">
<?php echo $row["violated_at"];?>
            </td>
<td>
<?php echo $row["review_department"].' > '.$row["review_username"].' > ';
if( $row["state"] == "no" )
	echo '案件改派';
...
<?php if( $page > 1 ) { ?>
      <li class="page-item">
  <a class="page-link" href="casesall.php?commit=搜尋">&laquo;</a>
</li>

      <li class="page-item">
      <a rel="prev" class="page-link" href="casesall.php?page=<?= $prev;?>&commit=搜尋">&lsaquo;</a>
</li>
...
for($i=$spage; $i<=$page-1; $i++ ): ?>
    ...
    <a rel="next" class="page-link" href="casesall.php?page=<?= $i; ?>&commit=搜尋"><?= $i; ?></a>
  </li>
<?php endfor; ?>
<?php } ?>
...
<?php } ?>
      ...
      <li class="page-item">
      <a rel="next" class="page-link" href="casesall.php?page=<?= $next; ?>&commit=搜尋">&rsaquo;</a>
</li>

      <li class="page-item">
      <a class="page-link" href="casesall.php?page=<?= $totoalPages;?>&commit=搜尋">&raquo;</a>
</li>
<?php  } ?>
...
<div class="hover_content" style="display: none;">
  ...
  break;
	case 'DetectLocation':
        ...
        echo '<option>現場圖</option>';
        echo '<option>事故照片</option>';
	echo '<option>初步分析研判表</option>';
?></select>'
  search_condition.val('cont').change();
  search_condition.find('option').not('[value="cont"]').attr('hidden', '')
  wrapper.html(input_html);
  wrapper.find('.search-value-input').select2();
	break;
        case 'expose':
	     var input_html = '<select class="search-value-input custom-select" name="' + value_input.attr('name') + '" id="' + value_input.attr('id') + '"><option>核發</option><option>退件</option></select>'
  search_condition.val('eq').change();
  search_condition.find('option').not('[value="eq"]').attr('hidden', '')
 wrapper.html(input_html);
 wrapper.find('.search-value-input').select2();
        break;
        case 'review_username':
	     var input_html = '<select class="search-value-input custom-select" name="' + value_input.attr('name') + '" id="' + value_input.attr('id') + '"><?php
$resultil = $pdo->query("SELECT * FROM `user_list` where `id`!=1 order by id");
while($rowil = $resultil->fetch(PDO::FETCH_ASSOC)){
        echo '<option>'.$rowil["name"].'</option>';
}
?></select>'
search_condition.val('eq').change();
search_condition.find('option').not('[value="eq"]').attr('hidden', '')
...
wrapper.find('.search-value-input').select2();
        break;
        case 'category_name':
             var input_html = '<select class="search-value-input custom-select" name="' + value_input.attr('name') + '" id="' + value_input.attr('id') + '"><option>A1</option><option>A2</option><option>A3</option></select>'
  search_condition.val('eq').change();
                                    search_condition.find('option').not('[value="eq"]').attr('hidden', '')
                              wrapper.html(input_html);
                                    wrapper.find('.search-value-input').select2();
        ...
        case 'violated_end':
          ...
          wrapper.html('').append(input)
        break;
        case 'auto_department':
             var input_html = '<select class="search-value-input custom-select" name="' + value_input.attr('name') + '" id="' + value_input.attr('id') + '"><option>第一分局</option><option>第二分局</option><option>第三分局</option><option>交通警察隊</option><option>新竹市警察局</option></select>'
  search_condition.val('eq').change();
                                    search_condition.find('option').not('[value="eq"]').attr('hidden', '')
                              wrapper.html(input_html);
                                    wrapper.find('.search-value-input').select2();
...
$resultil = $pdo->query("SELECT * FROM `user_list` where `id`!=1 order by id");
while($rowil = $resultil->fetch(PDO::FETCH_ASSOC)){
        echo '<option value="'.$rowil["id"].'" title="'.$rowil["name"].'">';
...
?></select>'
  ...
  function review_case(id) {
    ...
    $.post("/casesall.php?commit=搜尋", data)
  }
  function transform_cases(event) {
    if ($('.select_checkbox:checked').length > 0) {
      if (event == 'review') {
        ...
        if ($('[name="cases[department_id]"]').val() == '') {
          ...
          $.post("casesall.php?act=assign", { case_ids: ids, department_id: department_id })
        }
	...
	if( $('#cases_expose_false:checked').val() ) {
		if( !$('#cases_unexpose_reason_id').val() ) {
          ...
          $.post("casesall.php?act=allreview", { case_ids: ids, expose: expose, expose_msg: expose_msg,review_user_id: review_user_id,review_department: review_department }).done(function(date){ location.reload(true); });
		}
        } else {
        ...
        if ($('[name="cases[department_id]"]').val() == '') {
          ...
          $('.select_checkbox:checked')
          $.post("casesall.php?act=todepartment", { case_ids: ids, department_id: department_id }).done(function(date){ location.reload(true); });
        }
          ...
          $('.select_checkbox:checked')
          $.post("casesall.php?act=todepartment2", { case_ids: ids, department_id: department_id }).done(function(date){ location.reload(true); });
          ...
          $('.select_checkbox:checked')
          $.post("casesall.php?act=toready", { case_ids: ids, userid: userid }).done(function(date){ location.reload(true); });
          ...
          $('.select_checkbox:checked')
          $.post("casesall.php?act=alltonready", { case_ids: ids, userid: userid }).done(function(date){ location.reload(true); });
          ...
          $('.select_checkbox:checked')
          $.post("casesall.php?act=alltoready", { case_ids: ids, userid: userid }).done(function(date){ location.reload(true); });
          ...
          $('.select_checkbox:checked')
          $.post("casesall.php?act=alltoreview", { case_ids: ids, userid: userid }).done(function(date){ location.reload(true); });
          ...
          $('.select_checkbox:checked')
          $.post("casesall.php?act=alltorecheck", { case_ids: ids, userid: userid }).done(function(date){ location.reload(true); });
          ...
          $('.select_checkbox:checked')
          $.post("casesall.php?act=alltocomplete", { case_ids: ids, userid: userid }).done(function(date){ location.reload(true); });
      } else if( event == 'complete' ) {
        $('input[name="event"]').val(event);
	$('.index-form').attr('action', "casesall.php?act=complete&page=<?=$_GET["page"];?>").submit();
      } else if( event == 'ready' ) {
        $('input[name="event"]').val(event);
        $('.index-form').attr('action', "casesall.php?act=ready&page=<?=$_GET["page"];?>").submit();
      } else {
        $('input[name="event"]').val(event);
        $('.index-form').attr('action', "casesall.php?page=<?=$_GET["page"];?>").submit();
      }
    ...
    $(function(){
      ...
      return $('form').on('click', '.add_search_fields', function(event) {
        ...
        return event.preventDefault();
          ...
          //匯出csv
      function csv_btn() {
        var filename = "綜合查詢.csv";
        var url =
          "./php/GetExportCSVCar2.php<?php
$mediaa=array(
                "eq"=>"=",
                "cont"=>"=",
                "gteq"=>"=b_",
...
$buffb="";
        ...
        foreach( $value as $aa => $bb ) {
                if( $i!=0 ) {
                        if( $bb['a'][0]['name'] == "violated_at" ) {
                                $bb['a'][0]['name'] = 'violated_at_'.$j;
                                $j++;
                        }
?>
&<?=$bb['a'][0]['name'];?><?=$mediaa[$bb["p"]];?><?=$bb['v'][0]["value"];?>
<?php } else {
                        if( $bb['a'][0]['name'] == "violated_at" ) {
                                $bb['a'][0]['name'] = 'violated_at_'.$j;
                                $j++;
