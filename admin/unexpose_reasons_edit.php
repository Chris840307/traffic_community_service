...
if( $_POST["_method"] == "delete" ) {
	$pdo->prepare("delete from `unexpose_reasons` where `id`=?")->execute(array($_GET["id"]));
...
<div class="card mb-3">
    ...
    <div class="card-header">
      ...
      編輯退件原因
      <div class="float-right">    <a class="btn btn-primary btn-sm" href="unexpose_reasons.php">回到列表</a>
...
<span class="divider"></span>
    ...
    <div class="form-group row">
  <label class="col-sm-2 col-form-label col-form-label-md">退件原因</label>
  <div class="col-sm-5">
