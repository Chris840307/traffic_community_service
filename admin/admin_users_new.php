...
$pdo->prepare("INSERT INTO `user_list` (`name`,`acc`,`pwd`,`department_id`,`department`,`unit`,`cdate`) VALUES ( ?,?,?, ?, ?, ?,? )")->execute(array($_POST["report_user"]["name"],$_POST["report_user"]["username"],$_POST["report_user"]["password"],$_POST["report_user"]["department_id"],$rowd["dname"],$rowd["sname"],$cdate));
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <form class="simple_form new_report_user" id="new_report_user" autocomplete="off" action="admin_users_new.php" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="XPtXVm/tQsoeHMIWVrQ4Mse296z1CaQD+mz8Y5hlweHkh5ZUmRGaYjiDiCofzvjEtXRYQOmid9nnyq9RMNp+jQ==" />
<div class="card mb-3">

    <div class="card-header">
      <i class="far fa-info-square"></i>
      新增員警
      <div class="float-right">    <a class="btn btn-primary btn-sm" href="admin_users.php">回到列表</a>
...
<?=$name_msg2;?>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-5">
        <select class="form-control <?=$dep_msg;?> select optional form-control form-control-sm select2" onchange="getunits(this)" autocomplete="off" name="report_user[department_id]" id="report_user_department_id"><option value="">請選擇</option>
<option value="8" <?php if( $_POST["report_user"]["department_id"] == "交通警察隊" ) echo "selected";?>>交通警察隊</option>
</select>
<?=$dep_msg2;?>
      </div>
    </div>
...
<div class="form-actions">
  ...
  <a class="btn btn-secondary" href="admin_users.php">取消</a>
</div>
