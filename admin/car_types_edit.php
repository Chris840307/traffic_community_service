...
if( $_POST["_method"] == "delete" ) {
	$pdo->prepare("delete from `car_types` where `id`=?")->execute(array($_GET["id"]));
...
<?php
$result = $pdo->query("select * from `car_types` where `id`='".$_GET["id"]."'");
$row = $result->fetch(PDO::FETCH_ASSOC);
?>

          <form class="simple_form edit_report_user" id="edit_report_user_71" autocomplete="off" action="car_types_update.php" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="patch" /><input type="hidden" name="authenticity_token" value="/wTPxqg+6zcxzuHxwZP1+3OPowhW0MjTdLHN5Y8POkC5ZI3HV2cY7jn5v4wc1Li4n1XutES3czZYxOTwdmOvbw==" />
...
<div class="card mb-3">
    ...
    <div class="card-header">
      ...
      編輯車種
      <div class="float-right">    <a class="btn btn-primary btn-sm" href="car_types.php">回到列表</a>
...
<span class="divider"></span>
  ...
  <label class="col-sm-2 col-form-label col-form-label-md">車種名稱</label>
  <div class="col-sm-5">
    ...
    <div class="form-group row">
  <label class="col-sm-2 col-form-label col-form-label-md">車種代碼</label>
  <div class="col-sm-5">
